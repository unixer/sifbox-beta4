...
#include "../frontends/tbs62x0fe.h"
#include "tbsctrl.h"

#include "../frontends/tbs6925ctrl.h"

#include "../frontends/stv6110x.h"
#include "../frontends/stv090x.h"

#include "../frontends/stb6100.h"
#include "../frontends/stb6100_cfg.h"

#include "../frontends/tbs6984fe.h"
#include "../frontends/isl6423.h"

#include "../frontends/tbs6992.h"
#include "../frontends/tbs6992_cfg.h"

#include "tbsci-i2c.h"
#include "tbsci.h"

#include "../frontends/tbs6922fe.h"
#include "../frontends/tbs6928fe.h"
#include "../frontends/tbs6982fe.h"
#include "../frontends/tbs6991fe.h"

#include "../frontends/tbsfe.h"
...
static int saa716x_tbs6984_frontend_attach(struct saa716x_adapter *adapter, int count)
{
	...
	if (count == 2 || count == 3) {
		...
		dvb_attach(isl6423_attach,
				adapter->fe,
				&i2c0->i2c_adapter,
				&tbs_isl6423_config[0], (count-2)?1:0);
	...
	if (count == 0 || count == 1) {
		...
		dvb_attach(isl6423_attach,
				adapter->fe,
				&i2c1->i2c_adapter,
				&tbs_isl6423_config[0], (count)?1:0);
		tbs_read_mac(&i2c0->i2c_adapter, 160 + 16*count, mac);
		memcpy(adapter->dvb_adapter.proposed_mac, mac, 6);
		printk(KERN_INFO "TurboSight TBS6984 DVB-S2 card port%d MAC=%pM\n",
			count, adapter->dvb_adapter.proposed_mac);
